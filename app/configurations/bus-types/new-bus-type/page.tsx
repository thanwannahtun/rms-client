...
import { useAddBusType, useFetchBusTypes } from "@/lib/store/selectors/useBusTypes";
...
export default function CreateBusTypePage() {
    ...
    const handleSave = async () => {
        ...
        await addBusType({ id: null, name, layout, capacity: maxSeatsInRow * totalRows, rows: totalRows });
        // fetchBusTypes(); // refresh list
        router.push("/configurations/bus-types"); // go back to list
    };
        ...
        <div className="p-6 max-w-4xl mx-auto space-y-6">
            <div className="flex justify-between items-center">
                ...
                <div className="flex gap-2">
                    <Button variant="secondary" onClick={() => router.push("/configurations/bus-types")}>Discard</Button>
